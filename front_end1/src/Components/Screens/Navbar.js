    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item" id="themeButton">
        <a id ="dark" href="#" class="nav-link">
          ...
          <a id ="dark" href="#" class="nav-link" onChange={()=>setDarkmode(!darkmode)} onClick={()=>setDarkmode(!darkmode)}>
          <svg
            class="theme-icon"
            id="solarIcon"
            aria-hidden="true"
            ...
            onChange={()=>setDarkmode(!darkmode)} onClick={()=>setDarkmode(!darkmode)}
          >
            <g class="fa-group">
              <path
                fill="currentColor"
